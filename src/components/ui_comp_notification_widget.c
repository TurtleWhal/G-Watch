...
void ui_event_comp_Notification_Widget_Notification_Widget(lv_event_t * e)
{
    ...
    if(event_code == LV_EVENT_GESTURE &&  lv_indev_get_gesture_dir(lv_indev_get_act()) == LV_DIR_RIGHT) {
        ...
        NotificationDismissRight_Animation(comp_Notification_Widget[UI_COMP_NOTIFICATION_WIDGET_NOTIFICATION_WIDGET_VISIBLE],
                                           0);
...
lv_obj_t * ui_Notification_Widget_create(lv_obj_t * comp_parent)
{
    ...
    children[UI_COMP_NOTIFICATION_WIDGET_NOTIFICATION_WIDGET_VISIBLE_NOTIFICATION_IMAGE_PANEL] =
        cui_Notification_Image_Panel;
    children[UI_COMP_NOTIFICATION_WIDGET_NOTIFICATION_WIDGET_VISIBLE_NOTIFICATION_IMAGE_PANEL_NOTIFICATION_IMAGE] =
        cui_Notification_Image;
