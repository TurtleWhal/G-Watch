...
lv_obj_set_style_text_font(cui_Title, &lv_font_montserrat_12, LV_PART_MAIN| LV_STATE_DEFAULT);
...
lv_obj_set_style_text_font(cui_Text, &lv_font_montserrat_10, LV_PART_MAIN| LV_STATE_DEFAULT);
