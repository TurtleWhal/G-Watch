...
lv_obj_set_y( ui_Blocky_Clock_Battery_Contact, -4 );
lv_obj_set_align( ui_Blocky_Clock_Battery_Contact, LV_ALIGN_BOTTOM_MID );
...
lv_obj_set_y( ui_Blocky_Clock_Battery_Bar, -3 );
lv_obj_set_align( ui_Blocky_Clock_Battery_Bar, LV_ALIGN_BOTTOM_MID );
