...
lv_obj_set_style_img_recolor(ui_Compass_Arrow, lv_color_hex(0xFF6D00), LV_PART_MAIN| LV_STATE_DEFAULT);
...
lv_obj_set_style_text_color(ui_Compass_N, lv_color_hex(0xFF6D00), LV_PART_MAIN | LV_STATE_DEFAULT );
...
lv_obj_set_style_text_color(ui_Compass_Direction, lv_color_hex(0xFF6D00), LV_PART_MAIN | LV_STATE_DEFAULT );
