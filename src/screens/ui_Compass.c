...
lv_obj_set_style_text_font(ui_Compass_Deg, &ui_font_Monoton_40, LV_PART_MAIN| LV_STATE_DEFAULT);
...
lv_obj_set_style_text_font(ui_Compass_Direction, &ui_font_Monoton_40, LV_PART_MAIN| LV_STATE_DEFAULT);
