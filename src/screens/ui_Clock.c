...
lv_img_set_zoom(ui_Arc_Left_Image,140);
...
lv_img_set_zoom(ui_Step_Image,140);
...
lv_img_set_zoom(ui_Battery_Indicator,100);
...
lv_img_set_zoom(ui_Notification_Amount_Image,140);
