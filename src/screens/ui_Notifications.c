...
lv_obj_set_style_pad_top(ui_Notification_Panel, 40, LV_PART_SCROLLBAR| LV_STATE_DEFAULT);
lv_obj_set_style_pad_bottom(ui_Notification_Panel, 100, LV_PART_SCROLLBAR| LV_STATE_DEFAULT);
...
lv_obj_set_style_pad_left(ui_Brightness_Slider, 32, LV_PART_KNOB| LV_STATE_DEFAULT);
...
lv_obj_set_height( ui_No_New_Notifications_Label, LV_SIZE_CONTENT);   /// 0
