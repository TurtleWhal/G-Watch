...
ui_No_New_Notifications_Label = lv_label_create(ui_Notifications);
...
lv_obj_set_height( ui_Notification_Panel, 173);
...
lv_obj_clear_flag( ui_Notification_Widget2, LV_OBJ_FLAG_HIDDEN );    /// Flags
