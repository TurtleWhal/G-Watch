...
lv_label_set_text(ui_comp_get_child(ui_Debug_App_Button, UI_COMP_APP_BUTTON_APP_LABEL),"Debug");
...
lv_img_set_src(ui_comp_get_child(ui_Weather_App_Button, UI_COMP_APP_BUTTON_APP_IMAGE_PANEL_APP_IMAGE), &ui_img_mostly_cloudy_png);
...
lv_img_set_src(ui_comp_get_child(ui_Flashlight_App_Button, UI_COMP_APP_BUTTON_APP_IMAGE_PANEL_APP_IMAGE), &ui_img_flashlight_png);
...
lv_obj_set_style_img_recolor(ui_comp_get_child(ui_Flashlight_App_Button, UI_COMP_APP_BUTTON_APP_IMAGE_PANEL_APP_IMAGE), lv_color_hex(0xFFFFFF), LV_PART_MAIN| LV_STATE_DEFAULT);
lv_obj_set_style_img_recolor_opa(ui_comp_get_child(ui_Flashlight_App_Button, UI_COMP_APP_BUTTON_APP_IMAGE_PANEL_APP_IMAGE), 255, LV_PART_MAIN| LV_STATE_DEFAULT);
