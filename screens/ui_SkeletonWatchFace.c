...
void ui_SkeletonWatchFace_screen_init(void)
{
    ...
    lv_obj_set_style_img_recolor(ui_Skeleton_Watch_Face_Minute_Hand_Shadow, lv_color_hex(0x1A1A1A),
    ...
    lv_obj_set_style_img_recolor(ui_Skeleton_Watch_Face_Minute_Hand, lv_color_hex(0xB2B2B2),
                                 LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_img_recolor(ui_Skeleton_Watch_Face_Hour_Hand_Shadow, lv_color_hex(0x1A1A1A),
                                 LV_PART_MAIN | LV_STATE_DEFAULT);
